...
/** Bare SiGML-player org.csl that accepts SiGML input over a TCP/IP server
...
/** Creates the GUI for this player org.csl, packs it and displays it. */
	protected void createGUI() {
		...
		// org.csl has neither a menu nor a menu bar unless it's on Mac OS X
		// in which case the menu bar and org.csl menu will be there, and the
...
/** Creates the main org.csl window pane. */
