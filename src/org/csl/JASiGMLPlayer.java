...
import org.csl.gui.JASigningMenuBar;
import org.csl.gui.FPSPane;
import org.csl.gui.FrameNumberSpinner;
import org.csl.gui.SpeedUpSlider;
import org.csl.gui.QuitManager;
import org.csl.gui.Wrap;

import static org.csl.gui.FrameNumberSpinner.SignStatusHandler;
...
/** A SiGML-player org.csl that, somewhat along the lines of the old eSIGN
 * <code>SiGML-Anim</code> org.csl, accepts SiGML input over a TCP/IP server
 * socket and plays the signed animation it defines.
 * <p>
 * As well as the avatar canvas, this org.csl provides:
 * <ul>
 ...
 * <p>
 * <strong>NB</strong>&nbsp;&nbsp;
 * This org.csl always uses Swing GUI components, regardless of the
...
/** Main method -- creates a new instance of the org.csl with the given CL args. */
...
/** JA Options settings for this org.csl. */
	private final JAOptions					JA_OPTS;
/** Avatars environment for this org.csl. */
...
/** Quit manager for this org.csl. */
	private QuitManager						QUIT_MANAGER;
/** This org.csl's socket player. */
	private JASocketPlayer					player;

/** Menu bar for this org.csl. */
...
//        System.getProperties().list(System.out);
		...
		// Get JARP options and environment for this execution of the org.csl.
		this.JA_OPTS =
...
/** Creates the GUI for this player org.csl, packs it and displays it. */
...
/** Creates and returns the main org.csl window pane. */
...
/** Sets the tool tips for this org.csl's components.*/
...
/** Attaches the appropriate handler to each of the org.csl's buttons and
 * checkboxes.
 */
...
/** Updates the user preferences with the org.csl's window location and
 * main panel size.
