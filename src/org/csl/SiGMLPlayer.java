...
/** Socket Player used by this org.csl. */
 ...
 */
	...
	throws InterruptedException, InvocationTargetException, IOException {
        ...
        // Get JA options and environment for this execution of the org.csl.
		this.JA_OPTS =
...
/** Plays the given SiGML URL on this org.csl's player. */
...
/** Replay's the current SiGML animation on this org.csl's player. */
 ...
 */
	...
	"the JASigning video service org.csl running locally.";
	...
	protected void doVideoGen( boolean withDialog ) {
		...
		if (! this.player.ServiceIsAvailable()) {
			logger.log(LoggerConfig.INFOLevel, LoggerConfig.VIDEOMarker, 
				"JASigning video service org.csl not running");
