...
//
//	public JSONStreamGenFromAnim(String av, SiGMLAnimation anim, CASDataReceiver casrcvr,SToCALogger logger) {
//
//		this.AVATAR = av;
//		this.ANIM = anim;
...
//	}
	...
	public JSONStreamGenFromAnim(String av, SiGMLAnimation anim,SToCALogger logger) {
 ...
 */
	protected void doJSONStreamGen() {
		...
		try {
			...
			this.logp(ix.toString());
			this.completeJSONStreamGen();
		}

		this.completeJSONStreamGen();

		this.logp("signs count="+this.sCount);
	}
