...
/* harmony import */ var _user_dialog__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./user.dialog */ "./src/app/user/user.dialog.ts");
...
var UserComponent = /** @class */ (function () {
    function UserComponent(_dataTableService, _internalDocsService, dialog
    ...
    UserComponent.prototype.openDialog = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_user_dialog__WEBPACK_IMPORTED_MODULE_5__["UserDialog"], {
            width: '650px',
        ...
        dialogRef.afterClosed().subscribe(function (result) {
            if (result) {
                result['type'] = 'save';
                _this.postUser(result).subscribe(function (res) {
                    if (res.success) {
                        _this.ngOnInit();
                    }
                });
    ...
    UserComponent.prototype.deleteUser = function (id) {
        var _this = this;
        this._internalDocsService.deleteUser(id).subscribe(function (res) {
            if (res.success) {
                _this.ngOnInit();
            }
            else {
    ...
    UserComponent.prototype.editUser = function (id) {
        var _this = this;
        this._internalDocsService.getUser(id).subscribe(function (res) {
            var dialogRef = _this.dialog.open(_user_dialog__WEBPACK_IMPORTED_MODULE_5__["UserDialog"], {
                width: '650px',
    ...
    UserComponent.prototype.postUser = function (params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this._internalDocsService.queryUsers().toPromise()];
                    case 1:
                        _a.data = _b.sent();
    ...
    UserComponent.prototype.sort = function (sortEvent) {
        this.sortBy = sortEvent.name;
        this.sortOrder = sortEvent.order;
        this.filter();
    };
    UserComponent.prototype.page = function (pagingEvent) {
    ...
    UserComponent.prototype.showAlert = function (event) {
    ...
    ], UserComponent.prototype, "pagingBar", void 0);
...
var UserDialog = /** @class */ (function () {
    function UserDialog(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    }
    UserDialog.prototype.cancel = function () {
        this.dialogRef.close();
    };
    UserDialog = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'user-dialog',
            template: __webpack_require__(/*! ./user.dialog.html */ "./src/app/user/user.dialog.html"),
        }),
...
/* harmony import */ var _user_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./user.service */ "./src/app/user/user.service.ts");
...
/* harmony import */ var _user_dialog__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./user.dialog */ "./src/app/user/user.dialog.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HOME_ROUTE = [
    { path: '', component: _user_component__WEBPACK_IMPORTED_MODULE_8__["UserComponent"] }
];
var UserModule = /** @class */ (function () {
    ...
    UserModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                _user_component__WEBPACK_IMPORTED_MODULE_8__["UserComponent"], _user_dialog__WEBPACK_IMPORTED_MODULE_14__["UserDialog"]
            ],
            imports: [
            ...
            entryComponents: [
                _user_dialog__WEBPACK_IMPORTED_MODULE_14__["UserDialog"]
            ],
            providers: [
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.queryUsers = function () {
        return this._http.get(INTERNAL_DOCS_URL + '/dictionary/listUser')
    ...
    UserService.prototype.deleteUser = function (id) {
        var url = INTERNAL_DOCS_URL + '/dictionary/getUser';
    ...
    UserService.prototype.postUser = function (params) {
        var postUrl = INTERNAL_DOCS_URL + '/dictionary/postUser';
        var httpParams = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]()
            .set('id', params.id)
