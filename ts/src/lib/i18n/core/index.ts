// angular
import {
  ANALYZE_FOR_ENTRY_COMPONENTS, APP_INITIALIZER, Inject, InjectionToken, ModuleWithProviders, NgModule, Optional,
  SkipSelf
} from '@angular/core';
import { provideRoutes, Router, RouterModule, Routes, ROUTES } from '@angular/router';

// module
import { I18NRouterLoader, I18NRouterStaticLoader } from './i18n-router.loader';
import { I18NRouterPipe } from './i18n-router.pipe';
import { I18NRouterService, provideChildRoutes } from './i18n-router.service';

export * from './models/i18n-router-settings';
export * from './i18n-router.loader';
export * from './i18n-router.pipe';
export * from './i18n-router.service';
